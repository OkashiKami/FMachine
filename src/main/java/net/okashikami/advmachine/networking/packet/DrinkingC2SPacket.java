package net.okashikami.advmachine.networking.packet;

import net.fabricmc.fabric.api.networking.v1.PacketSender;
import net.okashikami.advmachine.util.IEntityDataSaver;
import net.okashikami.advmachine.util.ThirstData;
...
public class DrinkingC2SPacket {
    private static final String MESSAGE_DRINKING_WATER = "message.advmachine.drank_water";
    private static final String MESSAGE_NO_WATER_NEARBY = "message.advmachine.no_water";
