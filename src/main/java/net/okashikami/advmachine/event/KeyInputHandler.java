package net.okashikami.advmachine.event;
...
public class KeyInputHandler {
    public static final String KEY_CATEGORY_TUTORIAL = "key.category.advmachine.tutorial";
    public static final String KEY_DRINK_WATER = "key.advmachine.drink_water";
