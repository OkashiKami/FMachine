package net.okashikami.advmachine.block;

import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.fabricmc.fabric.api.object.builder.v1.block.FabricBlockSettings;
import net.okashikami.advmachine.AdvMachine;
import net.okashikami.advmachine.block.custom.EggplantCropBlock;
import net.okashikami.advmachine.block.custom.JumpyBlock;
import net.okashikami.advmachine.block.custom.TanzaniteLampBlock;
import net.okashikami.advmachine.item.ModItemGroup;
...
public class ModBlocks {
    ...
    private static Block registerBlockWithoutItem(String name, Block block) {
        return Registry.register(Registry.BLOCK, new Identifier(AdvMachine.MOD_ID, name), block);
    }
    ...
    private static Item registerBlockItem(String name, Block block, ItemGroup tab) {
        return Registry.register(Registry.ITEM, new Identifier(AdvMachine.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings().group(tab)));
    }

    public static void registerModBlocks() {
        AdvMachine.LOGGER.debug("Registering ModBlocks for " + AdvMachine.MOD_ID);
    }
}
