package net.okashikami.fmachine.client;

import com.mojang.blaze3d.systems.RenderSystem;
import net.fabricmc.fabric.api.client.rendering.v1.HudRenderCallback;
import net.okashikami.fmachine.FMachine;
import net.okashikami.fmachine.util.IEntityDataSaver;
...
public class ThirstHudOverlay implements HudRenderCallback {
    private static final Identifier FILLED_THIRST = new Identifier(FMachine.MOD_ID,
            "textures/thirst/filled_thirst.png");
    private static final Identifier EMPTY_THIRST = new Identifier(FMachine.MOD_ID,
